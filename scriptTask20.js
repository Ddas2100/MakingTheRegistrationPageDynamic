...
function onSubmit(event) {
    ...
    if(obj.name === '' || obj.email === '' || obj.phone === '') {
        ...
        axios.post("https://crudcrud.com/api/5de5e83c399a43c2b15c398e263ebd31/AppointmentData", obj)
            .then((response)=> {
...
function showUserOnScreen(obj) {
    ...
    editBtn.addEventListener('click', () => {
        axios.delete(`https://crudcrud.com/api/5de5e83c399a43c2b15c398e263ebd31/AppointmentData/${obj._id}`)
            .then((response) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/5de5e83c399a43c2b15c398e263ebd31/AppointmentData")
        .then((response) => {
            console.log(response);

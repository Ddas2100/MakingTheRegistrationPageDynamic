...
function onSubmit(event) {
    ...
    if(obj.name === '' || obj.email === '' || obj.phone === '') {
        ...
        axios.post("https://crudcrud.com/api/618758c5f34e4c6d884fd14e70c3cda0/AppointmentData", obj)
            .then((response)=> {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/618758c5f34e4c6d884fd14e70c3cda0/AppointmentData")
        .then((response) => {
